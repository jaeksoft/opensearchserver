...
public class SpellCheckArray {
	...
	public SpellCheckArray() {
		word = null;
		fieldName = null;
		suggest = null;
	}

	public SpellCheckArray(String name, String query,
			List<SpellCheckItem> spellCheckItem) {
		fieldName = name;
		suggest = new ArrayList<Suggestion>();
		for (SpellCheckItem spellItem : spellCheckItem) {
