...
@WebService(name = "Select")
public interface SoapSelect {

	public SelectResult search(@WebParam(name = "index") String index,
	...
	public SelectResult searchAndLog(@WebParam(name = "index") String index,
			@WebParam(name = "login") String login,
			@WebParam(name = "key") String key,
			@WebParam(name = "template") String template,
			@WebParam(name = "query") String query,
	...
	public SelectResult fullSearch(
