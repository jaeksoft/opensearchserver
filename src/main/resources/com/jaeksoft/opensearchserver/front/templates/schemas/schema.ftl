...
<div class="container">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Schema ${schema?html}</h4>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/schemas/${schema?url}/indexes" class="btn btn-primary">Indexes</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/schemas/${schema?url}/crawlers/web" class="btn btn-primary">Web crawls</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/schemas/${schema?url}/tasks" class="btn btn-primary">Tasks</a>
                </div>
            </div>
        </div>
    </div>
