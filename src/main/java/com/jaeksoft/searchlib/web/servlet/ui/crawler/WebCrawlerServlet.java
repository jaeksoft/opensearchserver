...
@WebServlet(urlPatterns = { "/ui/crawlers/web" })
public class WebCrawlerServlet extends AbstractUIServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6970718520817336020L;

	public final static String TEMPLATE = "crawlers/web.ftl";

	public final static String PATH = "/ui/crawlers/web";
