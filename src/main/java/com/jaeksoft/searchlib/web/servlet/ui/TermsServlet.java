...
@WebServlet(urlPatterns = { "/ui/terms" })
public class TermsServlet extends AbstractUIServlet {
	...
	public final static String TEMPLATE = "terms.ftl";

	public final static String PATH = "/ui/terms";
