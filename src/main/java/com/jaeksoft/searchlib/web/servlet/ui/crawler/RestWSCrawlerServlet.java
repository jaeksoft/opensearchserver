...
@WebServlet(urlPatterns = { "/ui/crawlers/rest-ws" })
public class RestWSCrawlerServlet extends AbstractUIServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6472665807158984162L;

	public final static String TEMPLATE = "crawlers/rest-ws.ftl";

	public final static String PATH = "/ui/crawlers/rest-ws";
