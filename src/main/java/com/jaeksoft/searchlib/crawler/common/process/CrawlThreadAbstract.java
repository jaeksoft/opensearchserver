...
public abstract class CrawlThreadAbstract<T extends CrawlThreadAbstract<T, M>, M extends CrawlMasterAbstract<M, T>>
	...
	protected CrawlThreadAbstract(Config config, String taskName, M crawlMaster, ThreadItem<?, T> uniqueThreadItem,
			InfoCallback infoCallback) {
		super(config, taskName, crawlMaster, uniqueThreadItem, infoCallback);
		currentStats = null;
