...
public class TaskMergeDataIndex extends TaskAbstract {
	...
	final protected TaskPropertyDef propLogin =
			new TaskPropertyDef(TaskPropertyType.textBox, "Login", "Login", "The login to the external index", 20);

	final protected TaskPropertyDef propApiKey = new TaskPropertyDef(TaskPropertyType.password, "API Key", "API Key",
			"The API Key to connect to the external index", 50);

	final private TaskPropertyDef[] taskPropertyDefs = { propSourceIndex, propLogin, propApiKey };
	...
	public void setValues(TaskProperties properties, String index, String login, String apiKey) {
		if (index != null)
