...
public class ResultDocuments extends AbstractResult<AbstractRequest>
    ...
    private ResultDocuments(ReaderInterface reader, AbstractRequest request, TreeSet<String> fieldNameSet,
	    int[] docArray) {
	super(request);
	this.reader = reader;
	this.fieldNameSet = fieldNameSet == null ? new TreeSet<String>() : fieldNameSet;
    ...
    public ResultDocuments(ReaderInterface reader, AbstractRequest request, TreeSet<String> fieldNameSet,
