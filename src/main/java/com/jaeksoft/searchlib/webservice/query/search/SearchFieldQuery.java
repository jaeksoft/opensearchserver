...
public class SearchFieldQuery extends SearchQueryAbstract {
	...
	public static class SearchField {
		...
		public enum Mode {
			PATTERN("Pattern"), TERM("Term"), PHRASE("Phrase"), TERM_AND_PHRASE("Term & phrase");
		...
		public SearchField(com.jaeksoft.searchlib.request.SearchField searchField) {
		...
		protected com.jaeksoft.searchlib.request.SearchField newSearchField() {
			return new com.jaeksoft.searchlib.request.SearchField(field, mode, boost, phraseBoost, phraseSlop,
					booleanGroup);
		}
	}
	...
	private static List<SearchField> newSearchFields(
		...
		if (searchFieldCollection.size() == 0)
			return null;
		List<SearchField> searchFields = new ArrayList<SearchField>(searchFieldCollection.size());
