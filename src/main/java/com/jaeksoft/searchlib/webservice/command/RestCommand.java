...
public interface RestCommand {
	...
	public CommonResult mergeJSON(@PathParam("index") String use, @QueryParam("login") String login,
			@QueryParam("key") String key, @QueryParam("index") String index);

	@GET
	@Produces(MediaType.APPLICATION_XML)
	@Path("/merge/{index}/xml")
	public CommonResult mergeXML(@PathParam("index") String use, @QueryParam("login") String login,
			@QueryParam("key") String key, @QueryParam("index") String index);
