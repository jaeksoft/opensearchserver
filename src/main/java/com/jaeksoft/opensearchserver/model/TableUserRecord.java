...
@Table("users")
public class TableUserRecord implements UserRecord {
    ...
    public TableUserRecord() {
        id = email = name = password = null;
        status = 0;
    }

    private TableUserRecord(final Builder builder) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof TableUserRecord))
            return false;
        if (o == this)
            return true;
        final TableUserRecord u = (TableUserRecord) o;
    ...
    public static Builder of(TableUserRecord user) {
    ...
    public static class Builder {
        ...
        private Builder(final TableUserRecord user) {
            uuid = user.getId();
        ...
        public TableUserRecord build() {
            return new TableUserRecord(this);
        }
