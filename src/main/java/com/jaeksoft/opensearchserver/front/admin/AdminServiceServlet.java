...
public class AdminServiceServlet extends BaseServlet {

    private final Components components;

    private final static String TEMPLATE = "admin/swagger.ftl";

    public AdminServiceServlet(final Components components) {
